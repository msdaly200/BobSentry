...
| **FGAP Engine v1** | Fine-Grained Admin Permissions v1, policy evaluation | CVE-2026-11986 (bypass) |
| **FGAPv2 Engine** | Fine-Grained Admin Permissions v2, delegated admin scoping | CVE-2026-9795 (role scope bypass) |
| **OIDC Token Endpoint** | `/realms/{r}/protocol/openid-connect/token`, token exchange | CVE-2026-4874, CVE-2026-9792, CVE-2026-4634, CVE-2026-9704 |
| **OIDC Auth Endpoint** | `/realms/{r}/protocol/openid-connect/auth`, redirect handling | CVE-2026-9689, CVE-2026-3872 |
...
| **Identity Broker / Federation** | IdP login flows, account linking, `IdentityBrokerService` | CVE-2026-3009 (disabled IdP bypass), CVE-2025-7365 (account takeover) |
| **UMA / Authorization Services** | UMA resource server, RPT issuance, policy evaluation | CVE-2026-4636 (uma_protection bypass) |
| **Single-Use Token Store** | `SingleUseObjectProvider`, action tokens, device codes | CVE-2026-4282 (namespace isolation) |
| **Refresh Token / Session Store** | Persistent sessions, refresh token revocation list | CVE-2026-9802 (revoked token reuse) |
| **Login UI / Theme** | Login themes, organisation selection page, FreeMarker templates | CVE-2026-37980 (stored XSS) |
